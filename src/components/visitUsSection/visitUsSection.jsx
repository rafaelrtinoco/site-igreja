...
export default function VisitUsSection() {
  const address = "Rua Jucuruçu, 282 - Parada XV de Novembro, São Paulo - SP - 08246-030";
  ...
  return (
    ...
    <section className="py-20 px-6 bg-olive-lighter">
      <div className="max-w-7xl mx-auto">
        {/* Título da Seção - Se necessário */}
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-terracotta font-cinzel">
            Onde estamos
          </h2>
          <p className="text-lg text-olive/80 mt-2">
            Venha nos conhecer.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-8 items-start">
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-8 text-olive">
            {/* Endereço */}
            <div>
              <h3 className="text-2xl font-semibold text-terracotta mb-3 font-cinzel">
                ENDEREÇO
              </h3>
              ...
              <a 
                ...
                className="inline-block mt-4 text-terracotta hover:text-brand-terracotta-light transition-colors font-medium"
              >
                Ver no mapa
              </a>
            </div>
          ...
          <div className="w-full lg:w-1/2 h-[400px] lg:h-[600px] bg-white rounded-lg shadow-xl overflow-hidden">
            <iframe
              src={googleMapsUrl}
              width="100%"
              height="100%"
