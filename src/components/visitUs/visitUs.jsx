    ...
    <section className="py-20 px-6 bg-olive-lighter">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-terracotta font-cinzel mb-6">
            Visite-nos
          </h2>
          ...
          <div className="w-full lg:w-1/2 flex flex-col gap-8 text-olive">
            ...
            <div>
              ...
              <a 
                ...
                className="inline-block mt-4 text-olive hover:text-terracotta-light transition-colors font-medium"
              >
                Ver no mapa
              </a>
            </div>
